...
export const AUDIENCES: Audience[] = [
  {
    ...
    faqs: [
      ...
      { question: 'Can I get a hangover IV at my hotel or home?', answer: 'Yes. Many mobile IV services come to your hotel room, Airbnb, or home — which is popular with travelers in cities like Toronto and Vancouver, and with wedding parties recovering the morning after.' },
...

  {
    ...
    faqs: [
      ...
      { question: 'How far in advance should I book?', answer: 'For weddings, book early — especially in busy wedding months and larger cities like Toronto and Vancouver — to secure your date and group size.' },
