...
export const TREATMENT_CONTENT: Record<string, TreatmentContent> = {
  'Hangover': {
    description: `Hangover IV therapy is a drip clinics market for the dehydration and nutrient depletion that follow heavy alcohol consumption. Alcohol acts as a diuretic, flushing water and electrolytes from your body while depleting B vitamins, vitamin C, and magnesium. The hepatic metabolism of alcohol also leaves behind acetaldehyde, a toxic byproduct responsible for many hangover symptoms. A hangover IV bypasses your digestive system, delivering fluids and replacement nutrients directly into your bloodstream, which matters most when an upset stomach makes drinking water hard.

Most hangover IV formulations include a litre of Lactated Ringer's or normal saline for rehydration, a high-dose B-complex (especially B1, B6, and B12), vitamin C, and magnesium. Many providers offer optional add-ons such as ondansetron (Zofran) for nausea or ketorolac (Toradol) for headache and body aches. Many clients describe it as a "reset button"; rest, water, electrolytes and time remain the baseline it is compared against, and no drip cures a hangover.

Clinics generally suggest having it within 4 to 8 hours of waking; that timing is anecdotal rather than studied. It is not a license to drink more, nor a substitute for moderation, but it is commonly booked by professionals, athletes, and frequent travellers who need to be functional after a long night.`,
    howItWorks: `A medical professional inserts a small IV catheter into a vein in your arm or hand. Over 30 to 60 minutes, the fluids and nutrients drip directly into your bloodstream, bypassing digestion. Rehydration starts as soon as the fluids run; some clients say they notice a difference within 15 to 20 minutes of the infusion starting, which is subjective and mostly the fluids.`,
    benefits: [
      'Rapid rehydration: a litre of fluids over 30 to 60 minutes, not sipped over hours',
      'Replaces B vitamins and magnesium depleted by alcohol metabolism',
      'Add-ons such as ondansetron target nausea; ketorolac targets headache and aches',
      'Commonly booked for the "back on your feet" morning after; results vary',
  ...
  'NAD+ Plus': {
    description: `NAD+ (nicotinamide adenine dinucleotide) is a coenzyme found in every living cell, involved in energy metabolism and several cellular housekeeping pathways. NAD+ levels decline naturally with age (research suggests by middle age we may have only about half the NAD+ we had in our twenties), and that decline has been linked in observational research to fatigue and cognitive slowdown. NAD+ IV therapy bypasses oral supplements (which have very poor bioavailability for NAD+) and delivers the molecule directly into the bloodstream; whether that meaningfully changes levels inside cells is still being studied.

NAD+ IV therapy is commonly booked for wellness goals such as energy, mental clarity, focus, and exercise recovery; none of these is an established indication. Some longevity-focused clients use NAD+ as part of a broader healthspan protocol. Sessions are notably longer than other IV therapies. NAD+ must be infused slowly to avoid side effects like chest pressure, anxiety, or stomach discomfort, so a standard 250mg dose can take 2 to 4 hours, and high-dose protocols (500mg+) can stretch to 6 to 8 hours.

NAD+ is one of the more researched IV interventions, but it remains an emerging area. Clinical evidence for the claimed benefits is limited, and results vary by individual. Most clinics sell it as a series of sessions rather than a single drip.`,
    howItWorks: `NAD+ is infused at a controlled, slow rate, mainly to limit side effects. The rationale clinics give is that raising circulating NAD+ supports the same pathways the coenzyme takes part in naturally, but how much of an infusion reaches cells, and what that changes, has not been established in human trials. Clinics typically describe any effect as building over the days after each session and sell it as a series.`,
    benefits: [
      'Commonly booked for energy and mental clarity',
      'Marketed for focus and cognitive performance',
      'Marketed for cellular health and longevity; human evidence is limited',
    ...
    costRange: '$79 to $799 (tracks dose)',
    costContext: `Price tracks dose. Published Toronto menus in TheDripMap's IV Price Index run roughly $79 to $799 per session, with a median near $250; higher doses sit at the top of that range. Multi-session packages are common, so ask for the per-session price.`,
    ...
    faqs: [
      ...
      { question: 'Why does a NAD+ drip take so long?', answer: 'NAD+ must be infused slowly because rapid administration triggers flushing, nausea and chest tightness. Stretching it to 2 to 4 hours keeps the experience comfortable. The long duration is a safety feature, not just a sign of a higher dose.' },
...
Clinics list it for three situations: ahead of cold-and-flu season or travel, at the first sign of an oncoming illness, and during chronic stress or recovery from prolonged illness. None of these uses is proven. Athletes book it ahead of competition, frequent travellers before long-haul flights, and some clients have it monthly.

The underlying nutrients have established roles in immune cell function (vitamin C in neutrophil and lymphocyte activity, zinc in T-cell maturation, glutathione as an intracellular antioxidant), but that is a fact about nutrition, not evidence that infusing them changes the course of an infection. A typical immune drip combines all of these in one infusion.`,
    howItWorks: `Over 30 to 45 minutes, the IV delivers vitamin C (typically 5,000 to 25,000mg), zinc, B-complex, and often glutathione directly into your bloodstream. The rationale clinics give is that these nutrients reach immune cells faster than oral doses; whether that changes the course of an infection has not been shown, and in a well-nourished person the surplus is excreted.`,
    benefits: [
      'High-dose vitamin C and zinc at levels oral supplements cannot reach',
      'Marketed for immune support during stress or illness',
      'Commonly booked before travel or during cold-and-flu season',
      'No proof it prevents or shortens a cold; treat it as supportive',
      'Glutathione is often included as an antioxidant add-on',
    ],
    whatToExpect: `A comfortable 30 to 45 minute drip in a clinic lounge or at home. You may feel a slight warmth or metallic taste during the vitamin C push, which is normal. Some clients report feeling a lift afterward; that is subjective and not a measured effect. No downtime required.`,
    ...
    faqs: [
      ...
      { question: 'What does the glutathione add?', answer: 'Glutathione is the body\'s main intracellular antioxidant, added as an antioxidant. Evidence for IV glutathione\'s wellness benefits is limited, but it is generally well tolerated under supervision.' },
    ],
  },

  'Beauty Glow': {
    description: `Beauty Glow IV therapy is built around glutathione, an antioxidant produced naturally in the liver, combined with biotin, vitamin C, and often B-complex and amino acids, and marketed for skin, hair, and nails. Glutathione is an antioxidant, and in lab settings it inhibits tyrosinase (an enzyme involved in melanin production), which is the rationale clinics give when marketing high-dose glutathione for skin brightening and even tone. The evidence for that effect in people is limited, and no injectable is approved for it.

The "beauty" or "glow" drip is one of the fastest-growing IV categories. Oral glutathione is largely degraded in the digestive tract before reaching the bloodstream, which is why clinics deliver it by IV; raising the blood level has not been shown to change how skin looks. Biotin is involved in keratin production and vitamin C is a cofactor for collagen synthesis, but neither fact is evidence that infusing them changes hair, nails or skin in people who are not deficient.

Clinics typically sell it as a series of 6 to 10 sessions over 8 to 12 weeks, then monthly maintenance, and describe any effect as gradual and cumulative. Single sessions are commonly booked before events, weddings, or photoshoots.`,
    howItWorks: `Glutathione is administered either as a slow push at the end of the infusion or mixed into the IV fluids. Vitamin C and B vitamins are infused first. The proposed mechanism is that circulating glutathione reaches skin cells and inhibits melanogenesis; this has not been reliably demonstrated in people. Biotin and amino acids are included for their roles in keratin and collagen synthesis. The full session typically runs 45 to 60 minutes.`,
    benefits: [
      'Marketed for skin brightening and even tone; evidence is limited and no injectable is approved for it',
      'Vitamin C, a cofactor in collagen synthesis',
      'Biotin, marketed for hair and nails (little benefit unless deficient)',
      'Glutathione, the antioxidant the drip is built around',
      'Sold as antioxidant support; a wellness add-on, not a treatment',
    ],
    whatToExpect: `Sessions are calm and spa-like. Some clients describe a subtle "glow" in the day or two after a session; that is subjective and not guaranteed. Single drips are commonly booked before special events; clinics usually recommend a series of 6 to 10, which raises both cost and cumulative exposure.`,
...
Most clients use weight-loss IVs as part of a 6-to-12-week protocol, often paired with B12 injections between IV sessions. Results vary significantly and depend almost entirely on the broader lifestyle changes accompanying the drips.`,
    ...
    relevantSpecialty: 'Preventive Medicine',
    whoItsFor: `This drip is best suited to adults already committed to a structured weight-management plan (a sustainable calorie deficit, activity and clinician guidance) who want supplemental metabolic and energy support, or who are nutrient-depleted from dieting. It is not appropriate for anyone expecting it to drive weight loss on its own, and it is not a substitute for prescription options like GLP-1 medications, which require separate medical evaluation.`,
    ...
    faqs: [
      { question: 'Is a weight-loss IV the same as Ozempic or semaglutide?', answer: 'No. Semaglutide and tirzepatide are prescription GLP-1 medications that require a prescriber. MIC / lipotropic IVs are nutrient-based, work by a different mechanism, and are not approved for weight loss.' },
...
The hydration drip is the go-to for clients who can't keep fluids down (severe nausea, food poisoning, post-illness) or who book it after intense exercise, long flights, or heat exposure. IV fluids are faster than oral fluids for people who cannot drink; for everyone else, drinking works nearly as well. It's also the most affordable IV in most clinics' menus and the most common entry point for first-time IV therapy clients.
...
Many providers offer hydration as a "build your own" base: you choose a litre of saline and then add vitamin C, B vitamins, magnesium, glutathione, or anti-nausea medication based on your needs. This modular approach makes it one of the most versatile IV options.`,
    howItWorks: `A litre of sterile saline (0.9% sodium chloride) or Lactated Ringer's solution is infused over 30 to 45 minutes through a small IV catheter. The fluid enters your bloodstream directly, restoring intravascular volume. Unlike oral fluids, which pass through the digestive system first, IV fluids enter circulation directly, which makes them faster than oral fluids for people who cannot drink.`,
    benefits: [
      'Fluids enter circulation directly rather than over hours',
      'Useful when oral hydration isn\'t possible (nausea, illness)',
      'Commonly booked after intense exercise, heat, or travel',
      'Modular: easy to add vitamins, electrolytes, or medications',
      'Most affordable IV therapy option',
    ],
    whatToExpect: `A quick 30 to 45 minute session in a clinic lounge or at home. Many clients say they feel clearer-headed and less thirsty by the time the bag finishes. There's no downtime; you can return to normal activities immediately.`,
  ...
  'Recovery': {
    description: `Recovery IV therapy is marketed to athletes, weekend warriors, and anyone recovering from intense physical exertion. The protocol combines amino acids (typically a blend including BCAAs, the branched-chain amino acids leucine, isoleucine, and valine), magnesium, B vitamins, vitamin C and glutathione as antioxidants, and a litre of IV fluids for rehydration.

Intense exercise creates micro-tears in muscle fibers, depletes glycogen, generates reactive oxygen species, and disrupts fluid and electrolyte balance. Recovery IVs deliver fluids and nutrients directly into circulation. Whether that speeds recovery beyond what oral hydration and nutrition achieve has not been shown; some clients report less delayed-onset muscle soreness (DOMS), which is subjective.

This drip is popular with marathoners, CrossFit athletes, cyclists, professional and college athletes, and anyone training for a specific event. It's also booked by clients recovering from physical labor, long hikes, or sports vacations.`,
    howItWorks: `Over 45 to 60 minutes, the IV delivers amino acids, magnesium, B vitamins, antioxidants and a litre of fluids. Rehydration after heavy sweating is the part with the clearest rationale; the rest is included on the basis of each nutrient's role in the body, not on trials showing the drip speeds recovery.`,
    benefits: [
      'Amino acids, included for their role in muscle protein synthesis',
      'Magnesium, commonly included for muscle tension and cramping',
      'Vitamin C and glutathione as antioxidant add-ons',
      'A litre of fluids to replace sweat losses',
      'Marketed for delayed-onset muscle soreness (DOMS); evidence is mixed',
    ],
  ...
  'Myers Cocktail': {
    description: `The Myers Cocktail is the original IV vitamin therapy, developed in the 1960s by Baltimore physician Dr. John Myers, who gave it for decades to patients with chronic fatigue, fibromyalgia, asthma, migraines, and other conditions; the trials that later examined it were small and their results mixed. The formula remains largely unchanged today: B-complex vitamins, B12, vitamin C, calcium, and magnesium, infused over 15 to 30 minutes. It is the most widely used and best-known IV cocktail in the field, and the foundation from which most modern IV therapy protocols evolved.

The Myers Cocktail's enduring popularity comes from its versatility on a menu. Clinics list it for a wide range of complaints: fatigue, muscle tension, migraine, asthma, seasonal allergies, and chronic stress. Each ingredient has a real role in the body, but that is not evidence the infusion changes any of those conditions. Many clients describe it as a general "tune-up", which is a fair description of how it is sold.

A small body of research has examined the Myers Cocktail in conditions like fibromyalgia and migraine; the trials were small and the results mixed. Most clients have a Myers as monthly maintenance or during stressful periods. It remains the entry-point IV that most clinics recommend for first-time clients who don't have a specific protocol in mind.`,
    howItWorks: `The classic formula is mixed into 250mL to 500mL of sterile saline and infused over 15 to 30 minutes, making it one of the shorter IV sessions available. The B vitamins, vitamin C, calcium, and magnesium enter the bloodstream and take part in the same processes they do when taken orally: energy metabolism, nerve and muscle function, and antioxidant activity.`,
    benefits: [
      'Broad vitamin and mineral top-up in one bag',
      'Historically given for fatigue, migraine, and fibromyalgia; trials small and mixed',
      'Magnesium, commonly included for muscle tension',
      'Short session: one of the quickest IV options',
      'Well-established formula with decades of use',
    ],
    whatToExpect: `A short 15 to 30 minute session. You may feel a warm sensation in your chest during the magnesium push; this is normal and passes within minutes. Some clients describe a lift in energy afterward, which is subjective.`,
    costRange: '$150 to $300',
  ...
  'Jet Lag': {
    description: `Jet lag IV therapy is marketed to travellers crossing multiple time zones, a population whose internal circadian rhythm gets desynchronized from local time, leading to fatigue, insomnia, brain fog, and gastrointestinal disruption that can last days. The typical jet-lag IV combines a litre of IV fluids (long-haul flights are dehydrating due to dry cabin air and limited oral hydration), B vitamins, magnesium, vitamin C, and sometimes melatonin, the one ingredient with reasonable evidence for shifting sleep timing.

Long flights cause both physiological dehydration (cabin humidity is typically 10 to 20%, compared to 30 to 65% on the ground) and circadian disruption. Both factors stack to produce the post-flight slump familiar to frequent travellers. The jet-lag IV addresses the dehydration component; nothing in a vitamin drip resets the body clock. Many clients have it within 12 to 24 hours of landing.
...
This IV is especially popular in destination cities. Las Vegas, Miami, New York, Los Angeles, and Toronto's downtown core all have clinics that cater to arriving business travellers and tourists who don't want to lose their first 24 to 48 hours to recovery. Mobile (hotel-room) service is widely available for this category.`,
    howItWorks: `Over 30 to 45 minutes, a litre of IV fluids replaces fluid lost to the dry cabin environment. B vitamins and magnesium are included for their general roles in energy metabolism and muscle relaxation; there is no evidence they shift the body clock. Optional melatonin has reasonable evidence for aiding sleep timing on a new schedule. Some clients report feeling more alert afterward, which is mostly rehydration.`,
    benefits: [
      'Rapid rehydration after dry cabin air',
      'B vitamins, included for energy metabolism',
      'Magnesium, commonly included; no evidence it resets the body clock',
      'Commonly booked for the post-flight "fog"; the fix for jet lag itself is light, sleep timing and time',
      'Mobile (hotel) service widely available, no need to leave your room',
    ],
    whatToExpect: `A quick 30 to 45 minute session, either at a clinic or in your hotel room. Some clients say they feel clearer by the end of the drip; sleep on local time depends on light exposure and sleep timing, not the infusion. Clinics usually suggest having it within 24 hours of arrival.`,
    ...
    faqs: [
      { question: 'Does an IV actually cure jet lag?', answer: 'No. It can rapidly rehydrate you and may help you feel better faster, but jet lag is mainly a circadian (body-clock) issue. The fixes with the best evidence are hydration, light exposure, sleep timing and sometimes melatonin.' },
  ...
  'Energy Boost': {
    description: `Energy Boost IV therapy is built around the B vitamins involved in converting food into usable energy. The formula centers on B12 (methylcobalamin or hydroxocobalamin, the bioactive forms), B-complex vitamins (especially B1, B2, B3, B5, B6), and often amino acids and vitamin C. These nutrients are cofactors in the Krebs cycle and electron transport chain, the cellular pathways that produce ATP. When any of them is genuinely deficient, energy production slows and fatigue sets in; when levels are normal, extra adds little.

B12 deficiency is surprisingly common, particularly among vegetarians, vegans, people over 50 (whose stomach acid production declines, impairing oral B12 absorption), and anyone taking acid-reducing medications long-term. Oral B12 absorption is highly variable, and IV (or intramuscular) delivery bypasses absorption issues entirely. The same applies to other B vitamins, which are water-soluble and not stored long-term in the body. IV delivery puts the full dose into circulation; in someone with normal levels, the excess is excreted.

This drip is commonly booked by busy professionals, parents, frequent travellers, and anyone going through a high-stress period looking for an energy lift; the benefit in people with normal B12 is modest at best. It's also booked as a "Monday morning reset" by clients who routinely sacrifice sleep and recovery for work or social demands.`,
    howItWorks: `Over 20 to 40 minutes, the IV delivers a high dose of B12 alongside the full B-complex range. These vitamins are cofactors in the enzymes that produce ATP from carbohydrates, fats, and proteins, which is the rationale clinics give. Some clients report an energy lift within hours; in people with normal levels much of that is hydration or expectation.`,
    benefits: [
      'High-dose B12 and B-complex, bypassing oral absorption',
      'B vitamins are cofactors in cellular energy metabolism',
      'Marketed as an energy lift without a caffeine crash; modest unless you are deficient',
      'Quick session: one of the fastest IVs available',
      'Commonly booked during high-stress, high-demand periods',
    ],
    whatToExpect: `One of the shorter IV sessions at 20 to 40 minutes. You may feel a subtle warmth as the B vitamins infuse. Some clients report feeling more energetic within a few hours; the effect is short-lived and subjective. Commonly booked weekly or biweekly during demanding periods.`,
    ...
    faqs: [
      ...
      { question: 'How long does it take?', answer: 'Most energy/B-complex IVs run about 20 to 40 minutes, and you can resume normal activities right away. Some people notice a same-day lift, though effects are typically short-term.' },
    ],
  },
...
B12 is also widely marketed as an energy and metabolism booster for people who are not deficient, and here the honest picture is different. If your B12 level is already normal, there is little evidence that extra B12 boosts energy, aids weight loss, or improves metabolism. Any lift some people feel is often modest and may reflect expectation. The clear, well-supported benefit is correcting an actual deficiency.`,
  ...
  'Glutathione': {
    description: `Glutathione is an antioxidant the body makes naturally in the liver, involved in neutralizing free radicals and regenerating other antioxidants. Because oral glutathione is largely broken down in the digestive tract, clinics deliver it as an IV push or an intramuscular injection to raise circulating levels directly. It is offered both as a standalone push and as a popular antioxidant add-on to other drips.
...
For antioxidant support, glutathione is generally well tolerated under supervision, but it is not a proven therapy for any disease. It is best viewed as a wellness add-on with realistic, modest expectations rather than a treatment that delivers dramatic results.`,
    howItWorks: `Glutathione is given as a slow IV push or an intramuscular injection so it reaches the bloodstream intact, since oral forms are mostly degraded before absorption. Once circulating, it is taken up by cells, where it takes part in antioxidant recycling alongside vitamins C and E. Its proposed effect on skin tone comes from inhibiting tyrosinase, the enzyme involved in melanin production, but this effect is not reliably demonstrated in people.`,
    benefits: [
      'Given by IV or injection because oral glutathione absorbs poorly',
      'Sold as antioxidant support; not a treatment for any condition',
      'Involved in recycling other antioxidants such as vitamins C and E',
      'Popular, generally well-tolerated add-on to other IV drips',
      'Marketed for skin brightening; evidence is limited and no injectable is approved for it',
    ],
    ...
    faqs: [
      ...
      { question: 'What does it actually do?', answer: "Glutathione is the body's main intracellular antioxidant and is involved in recycling other antioxidants. Beyond that, it is not a proven treatment for any disease, and evidence for wellness benefits is limited." },
...
It is important to be clear: this drip does not cure or shorten a viral cold or flu. Viruses run their course regardless, and no IV changes that. What the drip can do is relieve dehydration and specific symptoms while your immune system does its work, and it is no substitute for medical care when an illness is severe.`,
  ...
  'Migraine Relief': {
    description: `A Migraine Relief IV, often called a "migraine cocktail", is a wellness-clinic take on the hospital migraine cocktail. Emergency departments use IV magnesium and antiemetics for acute migraine under medical supervision, with monitoring and prescription dosing; a wellness drip is not that. What a clinic offers is fluids, magnesium and, where a prescriber is involved, anti-nausea or anti-inflammatory medication, marketed for people whose oral medication is not working or cannot be kept down.

A typical formulation combines IV magnesium, an anti-nausea medication such as ondansetron, an anti-inflammatory such as ketorolac (Toradol), B-complex vitamins, and fluids for hydration. Hospital migraine cocktails may also use antiemetics like metoclopramide or prochlorperazine. The clinic version borrows the ingredients without the emergency-department setting.

Because several of these are prescription medications, this is a clinical service that requires a clinician's involvement, not a routine vitamin drip. It is marketed for known migraine or recurrent severe headache, and crucially not for a brand-new, sudden, or "worst-ever" headache, which can signal a medical emergency.`,
    howItWorks: `Over roughly 30 to 60 minutes, the IV delivers magnesium, an antiemetic for nausea, an anti-inflammatory such as ketorolac where prescribed, and fluids. The IV route matters when nausea makes pills impossible. Emergency departments use these components under medical supervision; a wellness clinic offering them must have a prescriber involved, and results vary.`,
    benefits: [
      'Commonly booked when oral medication fails or cannot be kept down',
      'Emergency departments use IV magnesium and antiemetics under medical supervision; a wellness drip is not that setting',
      'Anti-inflammatory (such as ketorolac) only with a prescriber\'s order',
      'Antiemetic for the nausea that accompanies attacks, where prescribed',
      'Fluids for the dehydration that often accompanies an attack',
    ],
    whatToExpect: `Expect a clinical session of about 30 to 60 minutes, ideally in a calm, dim environment since light and sound worsen migraine. After a clinician reviews your history and confirms this is a familiar migraine pattern, the medications and fluids are infused while you rest. Response varies, and a wellness drip is not a substitute for emergency care. Because prescription drugs are involved, a clinician must be part of the process.`,
    costRange: '$150 to $350',
    ...
    faqs: [
      { question: 'Does a migraine IV really work?', answer: 'Emergency departments use IV magnesium and antiemetics for acute migraine under medical supervision, and a wellness drip borrows those ingredients, but it is not the same setting or oversight. Results vary by person, and it is not a substitute for a migraine plan from your doctor.' },
      ...
      { question: 'How fast does it relieve a migraine?', answer: 'Some people report relief during or shortly after the 30 to 60 minute infusion, since fluids and any prescribed medication enter the bloodstream directly when nausea makes pills impossible. Response varies between individuals, and there is no trial evidence on the wellness-clinic version.' },
  ...
  'GLP-1 Weight Loss': {
    description: `GLP-1 weight loss therapy uses prescription-only medications, semaglutide (Ozempic, Wegovy) and tirzepatide (Mounjaro, Zepbound), given as a once-weekly subcutaneous injection, not an IV drip. They are prescription drugs: whether they are appropriate for you, at what dose, and with what monitoring is a prescriber's decision, not a menu choice.

This is genuine prescription medicine, not a wellness add-on. It requires a medical evaluation, an appropriate clinical reason to prescribe, dose titration over weeks, and ongoing monitoring by a prescriber. It is also distinct from the MIC/lipotropic "Weight Loss" IV offered at many clinics: GLP-1s are approved prescription drugs, while lipotropic IVs are nutrient-based and not approved for weight loss. The two should not be confused.

A real-world caution concerns compounded versions. After the GLP-1 shortages were declared resolved in 2024 to 2025, routine compounding of semaglutide and tirzepatide became restricted, and some compounded or gray-market products carry quality, purity, and dosing concerns. Anyone pursuing GLP-1 therapy should verify the source and work with a legitimate prescriber and a licensed pharmacy.`,
    howItWorks: `GLP-1 medications mimic glucagon-like peptide-1, a gut hormone involved in appetite and blood-sugar regulation (tirzepatide also acts on a second receptor, GIP). Delivered as a small weekly self-injection under the skin, the dose is started low and increased gradually by the prescriber to limit side effects. What it does for you, and whether it is appropriate at all, is a conversation with that prescriber.`,
    benefits: [
      'Prescription-only medication; requires a prescriber\'s evaluation and ongoing monitoring',
      'Once-weekly self-injection under the skin, not an IV drip',
      'Dose is titrated over weeks by the prescriber',
      'Distinct from nutrient-based "weight loss" IVs, which are not approved for weight loss',
      'Source matters: verify the prescriber and the licensed pharmacy',
    ],
    whatToExpect: `This is a program, not a one-time drip. It begins with a medical evaluation and often bloodwork, after which a prescriber starts you on a low dose that is gradually increased over weeks. You self-administer a small subcutaneous injection once a week at home, with periodic follow-up visits to monitor side effects, progress, and dosing. GI side effects like nausea are common, especially early on, and any plan runs alongside diet and lifestyle changes over months.`,
    costRange: '$200 to $500 per month',
    costContext: `Monthly cost varies widely with the drug, the dose, and whether insurance or a manufacturer program applies. Insurance coverage is inconsistent and often depends on diagnosis. Confirm the price with the prescriber and pharmacy.`,
    ...
    faqs: [
      ...
      { question: 'How is this different from a weight-loss IV?', answer: 'GLP-1s are approved prescription medications that require a prescriber, while MIC/lipotropic weight-loss IVs are nutrient-based and not approved for that purpose. The two are entirely different products.' },
...
What hormone therapy is not is a quick wellness drip or an anti-aging shortcut. It requires a proper diagnosis, baseline and follow-up bloodwork, a prescriber, and ongoing monitoring for known risks. Used responsibly within that framework, it is a legitimate medical therapy; used without it, it can do harm.`,
  ...
  'High-Dose Vitamin C': {
    description: `High-dose vitamin C (IVC) delivers concentrations of ascorbic acid far beyond what the gut can absorb from pills, given by IV and marketed for antioxidant and immune support. Because intestinal absorption of oral vitamin C is capped, IV is the only way to reach the high plasma levels some protocols aim for. Clinics list it as a wellness and immune-support infusion.
...
There are also specific, mandatory safety steps. High doses can be dangerous for people with certain conditions, so screening (especially for G6PD deficiency) is required before treatment, not optional. Used within proper medical limits and screening, IVC is generally well tolerated; used carelessly, it can cause serious harm.`,
    howItWorks: `Over roughly 30 minutes to a couple of hours depending on dose, ascorbic acid is infused directly into the bloodstream, bypassing the gut's absorption ceiling to reach plasma levels impossible to achieve orally. At these concentrations vitamin C behaves differently than at dietary doses, which is why it is studied in research settings; that research is unsettled. Kidney function and G6PD status determine whether high doses are safe, which is why screening precedes any infusion.`,
    benefits: [
      ...
      'Investigational for any disease; treat any oncology claim with skepticism',
    ],
    ...
    whoItsFor: `IVC may appeal to adults seeking high-dose antioxidant or immune support who have been screened and cleared by a clinician. It is not appropriate for anyone with G6PD deficiency, significant kidney disease, or a history of oxalate kidney stones, and not for anyone hoping it will treat or cure a serious illness; treat any oncology claim from a clinic with skepticism and talk to your oncologist.`,
