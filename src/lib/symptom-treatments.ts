...
export const SYMPTOMS: SymptomOption[] = [
  {
    ...
    recommendedTreatment: {
      ...
      why: 'The most common starting point for fatigue on clinic menus: fluids plus B vitamins, at a fraction of the cost of NAD+. Persistent fatigue is a reason for bloodwork with your doctor, not a menu decision.',
      askBeforeBooking: [
  ...
  },
  {
    ...
    recommendedTreatment: {
      ...
      askBeforeBooking: [
        ...
        'How long before the event should I come in: 24h, 48h, week-of?',
        'Is biotin actually included (some clinics charge separately)?',
      ],
      typicalCost: '$200 to $400',
      duration: '45 to 60 min',
    },
  ...
  },
  {
    ...
    recommendedTreatment: {
      name: 'NAD+ Therapy',
      what: 'NAD+ (a coenzyme involved in cellular energy metabolism) infused slowly, usually 250-500 mg.',
  ...
  },
  {
    ...
    recommendedTreatment: {
      ...
      why: 'Clinics usually sell this as a weekly series for 4-8 weeks rather than a single session. Evidence for skin brightening is limited and no injectable is approved for it.',
      askBeforeBooking: [
        'Do you offer a discounted series package?',
        'What dose of glutathione per session?',
        'Where is the glutathione compounded, and what evidence do you have for the skin effect?',
      ],
      typicalCost: '$200 to $400 per session ($1.2k to $2.4k for a series)',
  ...
  },
  {
    ...
    recommendedTreatment: {
      ...
      typicalCost: '$300 to $700',
      duration: '15 to 60 min (varies by formulation)',
    },
  ...
  },
  {
    ...
    recommendedTreatment: {
      name: 'Myers\' Cocktail',
      what: 'The original IV wellness drip: B vitamins, magnesium, calcium, and vitamin C. ~50 years of use.',
      why: 'When you don\'t know what you need, Myers\' is the most common starting point. Most clinics offer it, it\'s well-tolerated, and it covers the most common deficiencies.',
      askBeforeBooking: [
