...
export const IV_COSTS: IvCost[] = [
  ...
  { slug: 'immune', name: 'Immune Support', low: 150, typical: 225, high: 330, unit: 'session', blurb: 'High-dose vitamin C with zinc and B-vitamins.' },
  ...
  { slug: 'vitamin-c', name: 'High-Dose Vitamin C', low: 100, typical: 175, high: 250, unit: 'session', blurb: 'Lower for 5 to 10 g; higher doses cost more.' },
  ...
  { slug: 'nad-250', name: 'NAD+ (250mg)', low: 250, typical: 300, high: 500, unit: 'session', blurb: 'Entry NAD+ dose; a 2 to 4 hour infusion. Price scales steeply with dose.' },
  ...
  { slug: 'magnesium', name: 'Magnesium', low: 30, typical: 100, high: 200, unit: 'session', blurb: 'Often a $25 to 35 add-on rather than a standalone session.', note: 'Most clinics sell magnesium as an add-on to a base drip.' },
  { slug: 'b12-shot', name: 'B12 Shot', low: 20, typical: 35, high: 75, unit: 'shot', blurb: 'An intramuscular shot, not a full IV.', note: 'Priced per shot, often a $25 to 35 add-on to a drip.' },
  { slug: 'mic-shot', name: 'Weight-Loss Support (MIC / Lipo)', low: 25, typical: 40, high: 75, unit: 'shot', blurb: 'Lipotropic (MIC) shot. Monthly programs run ~$99 to 179.', note: 'Priced per shot. Does not include semaglutide/GLP-1 programs.' },
...
export const PRICE_FACTORS: { title: string; body: string }[] = [
  { title: 'Ingredients & add-ons', body: 'Extra glutathione, B12, anti-nausea or high-dose actives each add $20 to 60 and push the total up fast.' },
  ...
  { title: 'Mobile vs in-clinic', body: 'At-home/hotel concierge service adds roughly $50 to 100 per visit.' },
  ...
  { title: 'Membership or package', body: 'Members and prepaid pack-buyers typically pay 15 to 30% less per session than walk-ins.' },
];
