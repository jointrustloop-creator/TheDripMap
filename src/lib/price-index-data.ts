...
toronto: {
    ...
    currency: 'CAD',
    clinicCount: 16,
    headline: { treatment: 'Standard IV vitamin drip', clinics: 8, low: 99, median: 150, high: 399 },
    rows: [
      { treatment: 'Standard IV vitamin drip', clinics: 8, low: 99, median: 150, high: 399 },
      { treatment: 'High-dose vitamin C', clinics: 8, low: 60, median: 197, high: 249 },
      { treatment: 'Glutathione', clinics: 8, low: 60, median: 131, high: 389 },
      { treatment: 'NAD+', clinics: 5, low: 79, median: 250, high: 799 },
      { treatment: 'Hydration', clinics: 5, low: 97, median: 170, high: 250 },
      { treatment: 'Beauty / glow', clinics: 4, low: 250, median: 315, high: 470 },
      { treatment: 'B12 injection', clinics: 3, low: 199, median: 220, high: 319 },
      { treatment: "Myers' Cocktail", clinics: 3, low: 106, median: 170, high: 299 },
      { treatment: 'Athletic recovery', clinics: 3, low: 125, median: 150, high: 199 },
    ],
    note: 'Immune support drips had too few published prices in this round to report a reliable range. Some ranges span both add-on pushes and full drips.',
  },
  edmonton: {
    city: 'Edmonton',
    citySlug: 'edmonton',
