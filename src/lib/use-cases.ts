...
export const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    description: 'IV therapy is a common supportive measure for those looking to address the dehydration that often accompanies the stomach flu. Many people find that when they are unable to keep fluids down, a direct IV infusion is the most effective way to restore balance. It is often used to help reduce the feeling of extreme weakness and lightheadedness that comes with severe dehydration. While it doesn\'t treat the virus itself, many people report that the rapid rehydration helps them feel significantly more comfortable as they recover.',
