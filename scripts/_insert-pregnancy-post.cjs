...
const P = {
  file: 'iv-therapy-pregnancy-breastfeeding-canada-2026.md',
  slug: 'iv-therapy-pregnancy-breastfeeding-canada-2026',
  title: 'IV Drips While Pregnant or Breastfeeding: Ask This First',
  meta_title: 'IV Drips While Pregnant: Ask This First (2026)',
  meta_description: 'Every confident yes online comes from someone selling drips. The honest picture of IV therapy in pregnancy and breastfeeding, and the questions to ask first.',
  excerpt: 'Hospital IV care in pregnancy is real medicine with diagnosis and monitoring. A wellness drip is a different product wearing the same equipment.',
  related_cities: [],
  query_family: 'iv therapy pregnant safe / iv drip morning sickness / iv vitamins breastfeeding',
};
