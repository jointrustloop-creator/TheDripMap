...
const P = {
  file: 'iron-infusion-canada-cost-coverage-2026.md',
  slug: 'iron-infusion-canada-cost-coverage-2026',
  title: 'Iron Infusions in Canada: Cost, Coverage and Waits (2026)',
  meta_title: 'Iron Infusion Canada: Cost and OHIP Coverage',
  meta_description: 'What an iron infusion costs in Canada, what OHIP covers in hospital versus a private clinic, why waits push people to pay, and what to ask first.',
  excerpt: 'The covered option is slow, the fast option is not covered. What an iron infusion actually costs in Canada, and how to tell if you need one at all.',
  related_cities: [],
  query_family: 'iron infusion cost ontario / iron infusion OHIP coverage / iron infusion toronto wait',
};
