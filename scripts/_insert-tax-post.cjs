...
const P = {
  file: 'iv-therapy-tax-deductible-canada-2026.md',
  slug: 'iv-therapy-tax-deductible-canada-2026',
  title: 'Is IV Therapy Tax Deductible in Canada? The CRA Answer (2026)',
  meta_title: 'Is IV Therapy Tax Deductible in Canada? (2026)',
  meta_description: 'The CRA position: the practitioner fee can qualify for the medical expense tax credit, the substances usually do not. What to claim and what receipt to ask for.',
  excerpt: 'The visit can be claimable, the bag usually is not. The actual CRA position on IV therapy and the medical expense tax credit, in plain language.',
  related_cities: [],
  query_family: 'iv therapy tax deductible canada / naturopath medical expense tax credit / METC IV vitamin',
};
