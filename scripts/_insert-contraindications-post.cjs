...
const P = {
  file: 'who-should-not-get-iv-therapy-canada-2026.md',
  slug: 'who-should-not-get-iv-therapy-canada-2026',
  title: 'Who Should Not Get IV Therapy? What Clinics Rarely Say (2026)',
  meta_title: 'Who Should Not Get IV Therapy? (2026)',
  meta_description:
    'Kidney disease, heart failure, pregnancy, G6PD and high-dose vitamin C: what published sources actually flag before you book an IV drip in Canada.',
  excerpt:
    'The question a clinic loses money by answering honestly. What published medical sources flag, who should talk to a doctor first, and what a real screening covers.',
  related_cities: [],
  query_family: 'who should not get IV therapy / IV therapy contraindications / IV drip side effects canada',
};
