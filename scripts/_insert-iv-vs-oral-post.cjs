...
const P = {
  file: 'iv-vs-oral-vitamins-absorption-canada-2026.md',
  slug: 'iv-vs-oral-vitamins-absorption-canada-2026',
  title: 'IV Vitamins vs Pills: The Honest Absorption Story (2026)',
  meta_title: 'IV Vitamins vs Pills: The Absorption Truth',
  meta_description: 'The 100 percent absorption claim is true and misleading. What NIH pharmacokinetics actually show, where IV genuinely wins, and the cost math clinics skip.',
  excerpt: 'A true statement implying a false comparison. What the absorption research actually shows about IV drips versus oral vitamins, and where each honestly wins.',
  related_cities: [],
  query_family: 'iv vitamins vs oral / iv therapy absorption / do iv drips work better than supplements',
};
