...
const P = {
  file: 'iv-drip-verdicts-evidence-2026.md',
  slug: 'iv-drip-verdicts-evidence-2026',
  title: 'IV Drip Verdicts 2026: Hangover, Myers, Glutathione, NAD+',
  meta_title: 'IV Drip Verdicts: Hangover, Myers, NAD+ (2026)',
  meta_description: 'Hydration, hangover, Myers cocktail, immune, glutathione and NAD+, each graded against neutral sources instead of clinic menus. With Canadian prices.',
  excerpt: 'Is it bullshit? The most asked IV therapy question, answered drip by drip with neutral sources: what works, what is unproven, and what has a regulatory record.',
  related_cities: [],
  query_family: 'do iv drips work / is iv therapy bullshit / myers cocktail evidence / glutathione iv safe',
};
