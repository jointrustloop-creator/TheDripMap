...
const P = {
  file: 'iv-therapy-checklist-before-you-book-2026.md',
  slug: 'iv-therapy-checklist-before-you-book-2026',
  title: 'The 10-Point IV Therapy Checklist Before You Book (2026)',
  meta_title: '10-Point IV Therapy Checklist Before You Book',
  meta_description: 'Ten checks before any IV drip, most doable from your phone: registers, screening, ingredients, sourcing, emergency plan and payment terms. Printable.',
  excerpt: 'Every check exists because something actually went wrong in this industry. The practical tool the investigations never gave consumers.',
  related_cities: [],
  query_family: 'iv therapy what to ask / iv clinic red flags / questions before iv drip',
};
