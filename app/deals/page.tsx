...
export const metadata: Metadata = {
  ...
  description: 'Live IV therapy deals and limited-time offers posted by clinics that have claimed their listing on The Drip Map. Find a drip deal near you.',
  alternates: { canonical: `${SITE_URL}/deals` },
  openGraph: {
    title: 'IV Therapy Deals & Offers Near You | The Drip Map',
    description: 'Live IV therapy deals posted by clinics that have claimed their listing on The Drip Map.',
    url: `${SITE_URL}/deals`,
    type: 'website',
  },
};
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-lg text-slate-500 leading-relaxed">
            Limited-time offers posted directly by clinics that have claimed their listing. Clinics turn these on when they have openings, so they change often. Check back before you book.
          </p>
        </div>
