...
const DRAFTS: { to: string; subject: string; text: string }[] = [
  {
    ...
    text: [
      ...
      '',
      'Claiming the listing lets you edit your services, add photos, respond to reviews, and unlock the Safety Verified badge.',
      '',
      'Talk soon,',
      'TheDripMap',
      'info@thedripmap.com',
  ...
  },
  {
    ...
    text: [
      ...
      '',
      'Once verified you can update services, add photos, and unlock the Safety Verified badge.',
      '',
      'TheDripMap',
      'info@thedripmap.com',
    ].join('\n'),
  },
  {
    ...
    text: [
      'Hi Insight team,',
      '',
      'Your claim went through on June 3 and your Insight Naturopathic Clinic listing on TheDripMap is now verified. Welcome.',
      '',
  ...
  },
  {
    ...
    text: [
      ...
      '',
      'Once verified you can edit services, add photos, and unlock the Safety Verified badge.',
      '',
      'TheDripMap',
      'info@thedripmap.com',
    ].join('\n'),
