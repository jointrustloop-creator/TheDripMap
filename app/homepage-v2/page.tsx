/*
 * Homepage v2 — preview at /homepage-v2.
 *
 ...
 * the editorial italic moments. Story arc: Find it → Browse it →
 * Understand it → Trust it → Book it.
 *
 * Reads:
 *  - scripts/product-research.md (the WHO + WHAT thesis)
 *  - design brief at the bottom of scripts/directory-submission-quick-fills.md
 *
 * Pulls all numbers and clinic data live from Supabase via getSiteStats +
 * getFeaturedListings — no hardcoded counts, no fake testimonials.
 */
...
// noindex this preview — we don't want it competing with the real homepage.
export const metadata: Metadata = {
  title: 'Homepage v2 (preview) | TheDripMap',
  description: 'Internal preview of the redesigned homepage. Not indexable.',
